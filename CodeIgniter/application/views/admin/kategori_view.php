            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h3 class="text-themecolor">Table Kategori</h3>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div align="right">
                                    <button type="button" class="btn waves-effect waves-light pull-left hidden-sm-down btn-success btn-lg" onclick="add_kategori()"><i class="glyphicon glyphicon-plus"></i>Add Kategori</button>
                                </div>
                                   ...
                                   <table id="table_id" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                      ...
                                      <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-warning" onclick="edit_kategori(<?php echo $kategori->idKategori;?>)"><i class="glyphicon glyphicon-pencil"></i>Edit</button>
                                                <button class="btn btn-danger" onclick="delete_kategori(<?php echo $kategori->idKategori;?>)"><i class="glyphicon glyphicon-remove"></i>Delete</button>
                                            </td>
                                        </tr>
                                        <?php }?>
                                       </tbody>
    ...
    <script src="<?php echo base_url('assets/admin/js/custom.min.js');?>"></script>
                 <script type="text/javascript">
                    ...
                    function save()
                    {
                      ...
                      {
                          url = "<?php echo site_url('kategori/kategori_update')?>";
                      }
                    ...
                    function delete_kategori(id)
                    {
                      if(confirm('Are you sure delete this data?'))
                      {
                        // ajax delete data from database
                          $.ajax({
                            url : "<?php echo site_url('kategori/kategori_delete')?>/"+id,
                            type: "POST",
                            dataType: "JSON",
                            success: function(data)
                            {
        ...
        <form action="#" id="form" class="form-horizontal">
          ...
          <div class="form-body">
            <div class="form-group">
              ...
              <div class="col-md-9">
                <input name="namaKategori" placeholder="Nama Kategori" class="form-control" type="text">
              </div>
            </div>
        </form>
          </div>
