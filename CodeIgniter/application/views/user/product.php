...
<!-- for bootstrap working -->
	...
	<!-- Title Page -->
	<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(<?php echo base_url('assets/images/bg111.jpg');?>);">
		<h2 class="l-text2 t-center">
			Handphone
		</h2>
		<p class="m-text13 t-center">
			New Arrivals Handphone Collection 2018
		</p>
	</section>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-sm-6 col-md-8 col-lg-9 p-b-50">
					...
					<!-- Product -->
					<div class="row">
						<?php foreach ($list_pilihan_barang as $daftar) {?>
						
						<div class="col-sm-12 col-md-6 col-lg-4 p-b-50">
							<!-- Block2 -->
							<div class="block2">
								<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
									<img src="<?php echo base_url().'assets/uploads/'.$daftar->foto;?>" width="250px" height="350px" alt="IMG-PRODUCT">
								...
								<div class="block2-txt p-t-20">
									<a href="<?php echo base_url().'index.php/ProductDetail/index/'.$daftar->idBarang;?>" class="block2-name dis-block s-text3 p-b-5">
										<?php echo $daftar->namaBarang;?>
									</a>

									<span class="block2-price m-text6 p-r-5">
										<?php echo 'Rp. '.$daftar->harga;?>
									</span>
								</div>
							</div>
						</div>
