					...
					<div class="p-r-50 p-r-0-lg">
						<div class="p-b-40">
							<div class="blog-detail-img wrap-pic-w">
								<img src="<?php echo base_url().'assets/uploads/'.$blog_detail_barang->foto;?>" height="400px" alt="IMG-BLOG">
							</div>

							<div class="blog-detail-txt p-t-33">
								<h4 class="p-b-11 m-text24">
									<?php echo $blog_detail_barang->namaBarang;?>
								</h4>
								</div>

								<p class="p-b-25">
								<?php echo $blog_detail_barang->deskripsi;?>
								</p>
							</div>
						</div>
