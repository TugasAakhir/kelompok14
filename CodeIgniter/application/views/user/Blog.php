			...
			<div class="row">
				<div class="col-md-8 col-lg-9 p-b-75">
					<div class="p-r-50 p-r-0-lg">
						<?php foreach ($blog_barang as $barang ) {?>
						<div class="item-blog p-b-80">
							<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="item-blog-img pos-relative dis-block hov-img-zoom">
								<img src="<?php echo base_url().'assets/uploads/'.$barang->foto;?>"  height="600px" alt="IMG-BLOG">
							</a>

							<div class="item-blog-txt p-t-33">
								<h4 class="p-b-11">
									<a href="<?php echo base_url().'index.php/BlogDetail/index/'.$barang->idBarang;?>" class="m-text24">
								...
								<a href="<?php echo base_url('index.php/BlogDetail/index');?>" class="s-text20">
									Lanjut membaca
